...
The basic metadata is not very helpful, just some basic numeric summaries re-organized. 
The power of `metaframe` comes from the ability to add metadata directly to 
the data object and to render that metadata out. 
